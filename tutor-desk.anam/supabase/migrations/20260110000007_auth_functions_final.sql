-- =============================================
-- TUTOR DESK - Auth Helper Functions Final
-- =============================================

-- Drop ALL existing check_rate_limit functions
DROP FUNCTION IF EXISTS check_rate_limit(VARCHAR, INET, VARCHAR);
DROP FUNCTION IF EXISTS check_rate_limit(VARCHAR, INET);
DROP FUNCTION IF EXISTS public.check_rate_limit(VARCHAR, INET, VARCHAR);
DROP FUNCTION IF EXISTS public.check_rate_limit(VARCHAR, INET);

-- Drop record_login_attempt
DROP FUNCTION IF EXISTS record_login_attempt(VARCHAR, INET, BOOLEAN, VARCHAR, TEXT, VARCHAR);
DROP FUNCTION IF EXISTS public.record_login_attempt(VARCHAR, INET, BOOLEAN, VARCHAR, TEXT, VARCHAR);
...
-- Grant with full signatures
GRANT EXECUTE ON FUNCTION check_rate_limit(VARCHAR, INET, VARCHAR) TO service_role;
GRANT EXECUTE ON FUNCTION record_login_attempt(VARCHAR, INET, BOOLEAN, VARCHAR, TEXT, VARCHAR) TO service_role;
