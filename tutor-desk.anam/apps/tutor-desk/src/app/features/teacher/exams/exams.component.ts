    ...
    <div class="exams-page">
      ...
      <header class="page-header">
        ...
        <div class="page-header__actions">
          <p-button label="Create Exam" icon="pi pi-plus" (click)="navigateToCreate()" [disabled]="subjects().length === 0" />
        </div>
      </header>
      ...
      <p-card styleClass="exams-table-card">
        ...
        @if (loading()) {
          ...
          <div class="empty-state">
            ...
            <p-button label="Create Exam" icon="pi pi-plus" (click)="navigateToCreate()" />
          </div>
        } @else {
          <p-table
            #dt
