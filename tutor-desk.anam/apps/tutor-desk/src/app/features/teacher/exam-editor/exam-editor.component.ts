      ...
      <header class="page-header">
        <div class="page-header__nav">
          ...
          <div class="page-header__content">
            <h1 class="page-header__title">{{ isEditMode() ? 'Edit Exam' : 'Create New Exam' }}</h1>
            <p class="page-header__subtitle">
              {{ isEditMode() ? 'Update exam details and questions' : 'Set up your exam with questions' }}
            </p>
          </div>
        </div>
          ...
          <ng-template #header>
            <div class="card-header">
              ...
              <div>
                ...
                <p class="card-header__subtitle">Basic information about the exam</p>
              </div>
            </div>
          </ng-template>
          ...
          <p-card styleClass="form-card questions-card">
            <ng-template #header>
              <div class="card-header">
                ...
                <div>
                  <h2 class="card-header__title">Questions ({{ questions().length }})</h2>
                  ...
                  <p-accordion-panel [value]="i">
                    <p-accordion-header>
                      <div class="question-header">
                        ...
                        <span class="question-preview">{{ question.questionText | slice:0:60 }}{{ question.questionText.length > 60 ? '...' : '' }}</span>
          ...
          <p-card styleClass="form-card question-form-card">
            <ng-template #header>
              <div class="card-header">
                ...
                <div>
                  <h2 class="card-header__title">{{ editingQuestion() ? 'Edit Question' : 'Add New Question' }}</h2>
...
export class ExamEditorComponent implements OnInit {
    ...
    if (this.isEditMode()) {
      ...
      this.db.exams.create({
        ...
        next: (exam) => {
          ...
          this.router.navigate(['/teacher/exams', exam.id, 'edit'], { replaceUrl: true });
        },
        error: (err) => {
  ...
  editQuestion(question: Question): void {
    ...
    // Clear and rebuild options array
  ...
  saveQuestion(): void {
    ...
    const options: QuestionOption[] = (formValue.options as { id: string; text: string }[]).map(o => ({
      id: o.id,
      text: o.text,
    }));
  ...
  confirmPublish(): void {
    this.confirmationService.confirm({
      message: 'Are you sure you want to publish this exam? Students will be able to take it once published.',
