    ...
    <div class="teachers-page">
      ...
      <header class="page-header">
        <div class="page-header__content">
          ...
          <p class="page-header__subtitle">View, approve and manage all teachers in the system</p>
        </div>
      ...
      <p-card styleClass="teachers-table-card">
        ...
        <p-table
          ...
          [loading]="loading()"
          [globalFilterFields]="['user.fullName', 'user.email', 'qualification', 'specialization']"
          [rowHover]="true"
          dataKey="id"
        ...
        >
          ...
          <ng-template #body let-teacher>
            <tr>
              <td>
                <div class="teacher-cell">
                  ...
                  <div class="teacher-cell__info">
                    <span class="teacher-cell__name">{{ teacher.user.fullName }}</span>
                    <span class="teacher-cell__email">{{ teacher.user.email }}</span>
                  </div>
                </div>
              </td>
              <td>
                <span class="qualification-text">{{ teacher.qualification ?? '-' }}</span>
              </td>
              ...
              <td>
                <span class="date-text">{{ teacher.createdAt | date:'MMM d, yyyy' }}</span>
              </td>
              <td>
    ...
    this.db.teachers.getAll({ pageSize: 100 }).pipe(
      ...
      next: (response) => {
        ...
        if (this.selectedStatus) {
          filtered = filtered.filter(t => t.user.status === this.selectedStatus);
        }
