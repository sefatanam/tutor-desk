  ...
  template: `
    <div class="dashboard">
      ...
      <section class="dashboard__stats">
        ...
        } } @else { @for (stat of statsCards(); track stat.title) {
        <p-card styleClass="dashboard__stat-card">
          <div class="stat-card">
                ...
                <td>
                  <div class="teacher-info">
                    ...
                    <div class="teacher-info__text">
                      ...
                      <span class="teacher-info__email">{{
                        teacher.user.email
                      }}</span>
                    </div>
                  </div>
            ...
            <ul class="approval-list">
              ...
              <li class="approval-item" pRipple>
                <div class="approval-item__user">
                  ...
                  />
                  <div class="approval-item__info">
                    <span class="approval-item__name">{{
                      teacher.user.fullName
                    }}</span>
                    <span class="approval-item__email">{{
                      teacher.user.email
                    }}</span>
                  </div>
                </div>
