    ...
    <div class="landing">
      ...
      <section class="landing__hero">
        ...
        <div class="landing__hero-visuals">
          <div
            class="landing__floating-card landing__floating-card--1 animate-float"
          >
            <i class="pi pi-check-circle"></i>
            <span>Exam Completed</span>
          </div>
          <div
            class="landing__floating-card landing__floating-card--2 animate-float"
          ...
          <div
            class="landing__floating-card landing__floating-card--3 animate-float"
      ...
      <section class="landing__simplicity">
        <div class="landing__simplicity-content">
          ...
          <p class="landing__simplicity-text">
            We believe in keeping things simple. No complex setups, no confusing
            interfaces. Just powerful tools that work the way you expect them
            to.
          </p>
      ...
      <section class="landing__motto">
        <div class="landing__motto-content">
          <h2 class="landing__motto-text">
            ...
            <span class="landing__motto-highlight"
              >education is life itself.</span
            >"
          </h2>
      ...
      <section id="about" class="landing__about">
        <div class="landing__about-content">
          ...
          <p class="landing__about-text">
            Tutor Desk was born from a simple idea: teachers deserve better
            tools. We've built a platform that understands the unique challenges
            of education and provides solutions that actually work.
          </p>
          <p class="landing__about-text">
            Our mission is to empower educators with technology that enhances,
            not complicates, the learning experience for both teachers and
            students.
          </p>
        </div>
      </section>
      ...
      <section class="landing__developer">
        <div class="landing__developer-content">
          ...
          <p class="landing__developer-text">
            Crafted using Angular, Supabase, and PrimeNG. Open source and
      ...
      <section class="landing__cta">
        <div class="landing__cta-content">
          ...
          <p class="landing__cta-subtitle">
            Join thousands of educators who have simplified their workflow with
            Tutor Desk.
          </p>
          <a routerLink="/auth/register">
            <button
              ...
              icon="pi pi-arrow-right"
              iconPos="right"
              class="p-button-lg p-button-rounded landing__cta-btn"
            ></button>
          </a>
        </div>
      </section>
      ...
      <footer class="landing__footer">
        <div class="landing__footer-content">
          <div class="landing__footer-brand">
            ...
            <p class="landing__footer-tagline">
              Empowering education, one exam at a time.
            </p>
          </div>
