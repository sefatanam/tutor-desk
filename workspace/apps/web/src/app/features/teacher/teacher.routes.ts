...
export const teacherRoutes: Routes = [
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./subject-form/subject-form.component').then(
  ...
  // @REVIEW: Subject report route - comprehensive report for a subject (must be before :id)
  {
    ...
    loadComponent: () =>
      import('./subject-report/subject-report.component').then(
        (m) => m.SubjectReportComponent
      ),
  ...
  },
  {
    path: 'subjects/:id',
    loadComponent: () =>
      import('./subject-detail/subject-detail.component').then(
  ...
  },
  {
    path: 'exams/create',
    loadComponent: () =>
      import('./exam-editor/exam-editor.component').then(
        (m) => m.ExamEditorComponent
      ),
