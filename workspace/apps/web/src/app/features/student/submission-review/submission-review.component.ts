        ...
        <div class="info-grid">
          ...
          <div class="info-item full-width">
            ...
            <span class="info-value warning">{{
              getAutoSubmitReasonLabel(submission()!.autoSubmitReason!)
            }}</span>
          </div>
          }
        </div>
        ...
        <div class="rank-content">
          ...
          <div class="rank-text">
            ...
            <span class="rank-total"
              >out of {{ totalSubmissions() }} students</span
            >
          </div>
        </div>
      </p-card>
          ...
          <div class="question-item" [class]="'status-' + item.status">
            ...
            <div class="options-list">
              ...
              <div
                class="option-item"
                [class.selected]="
                  displaySettings().showStudentAnswers &&
                  item.selectedOption?.id === option.id
                "
                [class.correct]="
                  displaySettings().showCorrectAnswers &&
              ...
              >
                <div class="option-marker">
                  @if (displaySettings().showCorrectAnswers &&
                  item.correctOption.id === option.id) {
                  <i class="pi pi-check-circle correct-icon"></i>
                  } @else if (displaySettings().showStudentAnswers &&
                  item.selectedOption?.id === option.id &&
                  (!displaySettings().showCorrectAnswers ||
                  item.correctOption.id === option.id)) {
                ...
                @if (displaySettings().showStudentAnswers &&
                item.selectedOption?.id === option.id) {
            ...
            @if (displaySettings().showExplanations &&
