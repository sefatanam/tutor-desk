        ...
        <p-card styleClass="exam-card">
          <div class="exam-card__header">
            ...
            <span
              ...
              [style.color]="card.exam.subject.color"
            >
        ...
        <div class="instructions-dialog">
          <div class="instructions-header">
            ...
            <p-tag
              ...
              [style]="{ background: selectedExam()!.exam.subject!.color }"
            />
            } @else {
            <p-tag
