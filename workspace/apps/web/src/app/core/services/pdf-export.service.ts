...
<body>
  ...
  <div class="result-banner ${passed ? 'passed' : 'failed'}">
    ...
    <div class="status">${passed ? 'PASSED' : 'FAILED'} (Passing: ${
      exam.passingMarks
    } marks)</div>
  </div>
  ...
  ${
    options.includeQuestions
      ? this.generateQuestionsHtml(questions, options)
      : ''
  }
  ...
  <div class="footer">
    Generated on ${this.formatDate(
      new Date()
    )} | Tutor Desk - Empowering Education
  </div>
</body>
</html>
    `;
  ...
  private generateQuestionsHtml(
    questions: readonly PdfQuestionItem[],
        ...
        const optionsHtml = q.options
          .map((opt, optIndex) => {
            ...
            if (isSelected && options.includeAnswers) {
              indicators.push(
                '<span class="option-indicator your-answer">Your Answer</span>'
              );
            }
            if (isCorrect && showCorrect) {
              indicators.push(
                '<span class="option-indicator correct-answer">Correct</span>'
              );
            }
        ...
        <div class="question-card">
          <div class="question-header">
            ...
            <div class="question-meta">
              ...
              ${
                options.includeTimeSpent
                  ? `<span>${this.formatTime(q.timeSpentSeconds)}</span>`
                  : ''
              }
          ...
          <div class="question-body">
            ...
            <div class="explanation">
              ...
              <div class="explanation-text">${this.escapeHtml(
                q.explanation
              )}</div>
            </div>
            `
