...
export type ExamSubjectAssignmentInsert =
  TablesInsert<'exam_subject_assignments'>;
export type ExamSubjectAssignmentUpdate =
  TablesUpdate<'exam_subject_assignments'>;
